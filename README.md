# go-twitter [![Build Status](https://travis-ci.com/qorpress/go-twitter.svg?branch=master)](https://travis-ci.com/qorpress/go-twitter) [![GoDoc](https://godoc.org/github.com/qorpress/go-twitter?status.svg)](https://godoc.org/github.com/qorpress/go-twitter)
<img align="right" src="https://storage.googleapis.com/dghubble/gopher-on-bird.png">

go-twitter is a fork of the https://github.com/dghubble/go-twitter client with new features as the Go client library for the [Twitter API](https://dev.twitter.com/rest/public). 

Check the [usage](#usage) section or try the [examples](/examples) to see how to access the Twitter API.
...
## Install
    ...
    go get github.com/qorpress/go-twitter/twitter

## Documentation

Read [GoDoc](https://godoc.org/github.com/qorpress/go-twitter/twitter)
